...
import com.dal.mysql.demo.dao.FreeEntityPojo;
import com.dal.mysql.demo.dao.FreePersonDao;
import com.dal.mysql.demo.dao.Person;
...
public class FreePersonDaoUnitTest {
	...
	private static final String DATA_BASE = "MySqlSimpleDbShard";
	...
	private static FreePersonDao dao = null;
	...
	public static void setUpBeforeClass() throws Exception {
		...
		**/
		...
		dao = new FreePersonDao();
		// To customize person DAO, make this instance point to specified logic DB, so it will shard by DB
		DalParser<Person> parser = new DalDefaultJpaParser<>(Person.class, "MySqlSimpleDbShard", "person");
